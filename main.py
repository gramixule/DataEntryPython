...
# icon not implemented for now
# icon_image=PhotoImage(file=)
# root.iconphoto(False,icon_image)

# heading
Label(root, text="Please fill out this entry form:", font="arial", bg="#326273", fg="#fff").place(x=20, y=20)
...
Button(root, text="Exit", bg="#326273", fg="white", width=15, height=2, command=lambda: root.destroy()).place(x=480,
                                                                                                              y=350)
